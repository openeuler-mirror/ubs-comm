...
|名称|包名|发布类型|说明|获取地址|
|--|--|--|--|--|
|UBS Comm|ubs-comm-lib-{version}.oe2403sp3.aarch64.rpm<br>ubs-comm-devel-1.0.0-15.oe2403sp3.aarch64.rpm|开源|UBS Comm软件安装包。|[获取src-openeuler/ubs-comm仓库构建](https://gitcode.com/src-openeuler/ubs-comm?source_module=search_project)|
...
3. 获取与操作系统匹配的MLNX\_OFED驱动包至本地。
    ...
    地址为[单击地址](https://network.nvidia.com/products/infiniband-drivers/linux/mlnx_ofed/)。
