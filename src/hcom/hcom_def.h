...
T exchangeHcom(T &obj, U &&new_value)
{
...
struct UBSHcomNetTransDataIov {
    ...
    UBSHcomNetTransDataIov(uintptr_t address, uint64_t key, uint32_t size) : address(address), key(key), size(size) {}
};
