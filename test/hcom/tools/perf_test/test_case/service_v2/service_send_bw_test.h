 ...
 */
#ifndef HCOM_PERF_TEST_SERVICE_SEND_BW_H
#define HCOM_PERF_TEST_SERVICE_SEND_BW_H
#include <semaphore.h>
#include "hcom/hcom.h"
...
namespace hcom {
namespace perftest {
class ServiceSendBwTest : public PerfTestBase {
public:
    ServiceSendBwTest(const PerfTestConfig &cfg) : PerfTestBase(cfg), mHelper(cfg){};
...
private:
    ...
    int RequestPosted(const ock::hcom::UBSHcomServiceContext &ctx);
